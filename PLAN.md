...
- 请务必给每行代码都写上详细的注释
- 动画效果：
    - 相邻的两帧，同样的价格，就先不要有位置的移动了，可以先展示变化的那个动画，再做整体的平移
    - 变化的那部分，要有分割线和原本的区分开来
    - 每帧动画要显示triggerInfo的type

## 边界框定

本项目要生成的所有东西，包括代码、环境、toy数据等等，都放在这个项目文件夹下面，并且所有生成的这些文件，都需要记录他们的详细信息，记录在一个新的markdown里面